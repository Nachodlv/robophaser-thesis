...
namespace Utils.Pools
{
    public class ObjectPooler<T> where T : Pooleable
    {
        ...
        protected void Grow()
        {
            ...
            {
                var newObject = InstantiateObject(_objectToPool, _parent.transform);
        ...
        protected virtual T InstantiateObject(T objectToPool, Transform parent)
        {
            return Object.Instantiate(objectToPool, parent, true);
        }
    }
}
